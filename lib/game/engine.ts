...
export function createGame(host:HTMLDivElement,onReady:()=>void,onHistory:(n:number)=>void,onGuidance:(message:string)=>void=()=>{}):GameAPI{
 ...
 if(scene.fog instanceof THREE.FogExp2)scene.fog.density=THREE.MathUtils.lerp(.0009,.0032,THREE.MathUtils.smoothstep(view,30,120));
