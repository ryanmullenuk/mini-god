...
export type Tool='guide-torch'|'guide-bonfire'|'guide-granary'|'guide-storehouse'|'fishing'|'trap'|'guide-coop'|'guide-pigpen'|'settle'|'move'|'raise'|'lower'|'path'|'guide-home'|'guide-farm'|'rally'|'guide-temple'|'guide-slaughterhouse'|'rain'|'bloom';
const guideKind=(tool:Tool):GuidanceKind|null=>tool==='guide-torch'?'torch':tool==='guide-bonfire'?'bonfire':tool==='guide-granary'?'granary':tool==='guide-storehouse'?'storehouse':tool==='fishing'?'fishing':tool==='trap'?'trap':tool==='guide-coop'?'coop':tool==='guide-pigpen'?'pigpen':tool==='settle'?'settle':tool==='guide-home'?'home':tool==='guide-farm'?'farm':tool==='guide-temple'?'temple':tool==='guide-slaughterhouse'?'slaughterhouse':tool==='rally'?'rally':tool==='rain'?'rain':tool==='bloom'?'bloom':null;
